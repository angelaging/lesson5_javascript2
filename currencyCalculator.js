...
function calculateCurrency(){
    ...
    document.getElementById("currencyExchangeInfo").innerHTML = ("Selling $" + ("$%.2f " , usdAmount) + " USD ====> Buys $" + ("$%.2f"  , exchangeRate) + " " + countryName);
